...
"""ZDT2 multi-objective test function."""
...
class ZDT2(BaseMultiObjectiveTestFunction):
    """ZDT2 multi-objective test function.

    The ZDT2 function is a widely used benchmark for multi-objective
    optimization. It has a concave (non-convex) Pareto front.
    ...
    **kwargs
    ...
    Examples
    --------
    >>> from surfaces.test_functions.algebraic.multi_objective.zdt import ZDT2
    >>> func = ZDT2(n_dim=30)
