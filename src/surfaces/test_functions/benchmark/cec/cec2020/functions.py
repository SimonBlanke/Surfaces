...
"""CEC 2020 Basic Benchmark Functions (F1-F4)."""
...
class ShiftedRotatedBentCigar2020(CEC2020Function):
...
class ShiftedRotatedSchwefel2020(CEC2020Function):
    """F2: Shifted and Rotated Schwefel's Function.

    Properties:
    - Multimodal
    - Non-separable
    - Deceptive (global optimum near boundary)
    """
...
class ShiftedRotatedLunacekBiRastrigin2020(CEC2020Function):
...
class ExpandedGriewankRosenbrock2020(CEC2020Function):
    ...
    def _batch_objective(self, X: ArrayLike) -> ArrayLike:
        ...
        # Rosenbrock component for each pair
        z_curr = Z[:, :-1]
        z_next = Z[:, 1:]
