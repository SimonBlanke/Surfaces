...
class SearchDataManager:
    ...
    def __init__(self, data_dir: Optional[str] = None):
        ...
        if data_dir is None:
            ...
            self.data_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), "search_data")
        else:
    ...
    def store_evaluation(
        self, function_name: str, parameters: Dict[str, Any], score: float, evaluation_time: float
    ) -> None:
        """
    ...
    def store_batch(
        ...
        evaluations: List[Tuple[Dict[str, Any], float, float]],
    ) -> None:
        """
