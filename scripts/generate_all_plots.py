...
def get_function_instance(class_name):
    ...
    try:
        ...
        if class_name in ['SphereFunction', 'RastriginFunction', 'RosenbrockFunction', 
                         'StyblinskiTangFunction', 'GriewankFunction']:
...
def generate_plots():
    ...
    for func_name, config in FUNCTION_CONFIGS.items():
        ...
        try:
            ...
            # Generate file name
            file_name = func_instance._name_ if hasattr(func_instance, '_name_') else func_name.lower()
