...
from surfaces._search_data_collection import SearchDataCollector, SearchDataManager
...
class TestSearchDataCollector:
    ...
    def test_collect_search_data_custom_search_space(self, collector, mock_function):
        ...
        stats = collector.collect_search_data(
            mock_function, search_space=custom_search_space, verbose=False
        )
    ...
    def test_collect_search_data_batch_processing(self, collector, mock_function):
        ...
        stats = collector.collect_search_data(mock_function, batch_size=2, verbose=False)
    ...
    def test_collect_search_data_invalid_search_space(self, collector, mock_function):
        ...
        with pytest.raises(ValueError) as exc_info:
            collector.collect_search_data(
                mock_function, search_space=invalid_search_space, verbose=False
            )
    ...
    def test_timing_measurement_accuracy(self, mock_time, collector, mock_function):
        ...
        time_sequence = [
            0.0,  # collection start
            1.0,
            1.1,  # eval 1 (param1=1, param2=a)
            2.0,
            2.2,  # eval 2 (param1=1, param2=b)
            3.0,
            3.2,  # eval 3 (param1=2, param2=a)
            4.0,
            4.3,  # eval 4 (param1=2, param2=b)
...
class TestIntegrationWithRealMLFunction:
    ...
    def test_real_ml_function_collection(self, collector):
        ...
        stats = collector.collect_search_data(func, search_space=small_search_space, verbose=False)
    ...
    def test_real_ml_function_timing_statistics(self, collector):
        ...
        collector.collect_search_data(func, search_space=small_search_space, verbose=False)
